  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <section className="relative pt-32 pb-20 px-6">
        {/* Gradient blob */}
        <div
          className={`absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-gradient-to-r ${project.gradientFrom} ${project.gradientTo} opacity-10 blur-[120px] rounded-full pointer-events-none`}
        />
      ...
      <section className="px-6 pb-32">
        <div className="max-w-4xl mx-auto text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r ${project.gradientFrom} ${project.gradientTo} text-white font-semibold text-lg hover:opacity-90 transition-opacity`}
          >
