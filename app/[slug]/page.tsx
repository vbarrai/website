      ...
      <section className="px-6 pb-32">
        <div className="max-w-4xl mx-auto text-center flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-6 sm:px-8 py-4 rounded-full bg-white/5 border border-white/10 text-zinc-300 font-semibold text-base sm:text-lg hover:bg-white/10 transition-all"
          >
